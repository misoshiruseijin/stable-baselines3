"""
Final version of training script for placing (ballbasket) environment in robosuite.
Trains weights for all cartesian axis + gripper action simultaneously.

Algorithm: Random TAMER (SAC with feedback rate = 0)
